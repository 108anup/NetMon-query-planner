...
* Things that must be done
  ...
  :END:
** DONE [#A] Better name for our system                             :writing:
   CLOSED: [2020-06-02 Tue 23:18]
...
** [#A] PROG OpenVSwitch style and multicore implementation
   DEADLINE: <2020-05-10 Sun>
   :PROPERTIES:
   :TIME:     1d 0:00
   :END:
*** DONE [#A] profiling and verification of OVS with sketching   :experiment:
    CLOSED: [2020-06-02 Tue 23:18]
    :PROPERTIES:
    :TIME:     0.5d
    :END:
...
** DONE [#A] Handling changes in topology and requirements :implementation:experiment:
   CLOSED: [2020-06-02 Tue 23:19] DEADLINE: <2020-05-14 Thu>
   :PROPERTIES:
   :TIME:     3d
   :END:
...
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| DONE    | \_  Better name for our system                                                                            |          |                     |          | A        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
...
|         | \_      NetMon puts sketch with lower traffic on CPUs to improve overall throughput and reduce resources! |          |                     |          | N        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| PROG    | \_  OpenVSwitch style and multicore implementation                                                        |  1d 0:00 | <2020-05-10 Sun>    |          | N        |
| DONE    | \_    profiling and verification of OVS with sketching                                                    |     0.5d |                     |          | A        |
| DISCUSS | \_    Best way to implement shared queue?                                                                 |          |                     | Alan     | A        |
|         | \_      OVS thread                                                                                        |          |                     |          | N        |
|         | \_      Separate process?                                                                                 |          |                     |          | N        |
...
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| DONE    | \_  Handling changes in topology and requirements                                                         |       3d | <2020-05-14 Thu>    |          | A        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
|         | \_  Evaluation device profiles - one device at a time                                                     |  2d 0:00 | <2020-05-17 Sun>    |          | B        |
| PROG    | \_    setup - convert solver output to running script and profiling task                                  |       1d |                     |          | N        |
| PROG    | \_    running                                                                                             |       1d |                     |          | N        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| PROG    | \_  Add more types of sketches                                                                            |  1d 0:00 |                     |          | B        |
| DONE    | \_    Non linear accuracy relations                                                                       |       1d |                     |          | N        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
...
| TODO    | \_    Check how fast non clustering solver reaches clustered solution                                     |          |                     |          | A        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| HOLD    | \_  Performance vs system load                                                                            |       3d |                     |          | C        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| TODO    | \_  Need to email barefoot Faster with paper 10 days before for checking IP violations                    |          |                     |          | C        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| HOLD    | \_  Mix cluster refinement and cluster optimization                                                       |       2d |                     |          | B        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
| DONE    | \_  Modes of operation                                                                                    |          |                     |          | A        |
|---------+-----------------------------------------------------------------------------------------------------------+----------+---------------------+----------+----------|
...
* TODOs
** gravity model for TM generation: 
   http://www.maths.adelaide.edu.au/matthew.roughan/papers/ccr_2005.pdf
